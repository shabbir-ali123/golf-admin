...
import { setUpEventPayment, setUpTeacherPayment, updateEventPayment, updateTeacherPayment } from '../api/subscriptionFee';

interface TeacherFeemodelProp {

    onClose?: any;
    formData?: any
}

const TeacherFeeModel: React.FC<TeacherFeemodelProp> = ({ onClose, formData }) => {
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        if(formData != null){
            updateTeacherPayment(formdata, handleLoading);
        }else{
            setUpTeacherPayment(formData, handleLoading);
        }
        onClose(false)
    }
    useEffect(()=>{
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white rounded-md w-full max-w-lg p-6 relative">
                ...
                <form onSubmit={handleSubmit}>
                    <h2 className="text-black font-bold py-4 text-center text-2xl">Add New Teacher Fee</h2>
                    <div>
...
export default TeacherFeeModel;